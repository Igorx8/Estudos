...
"hash": "5c549ad30f9abf48dc5de36d20fa707014be1ff3"
 ...
 created(){
     ...
     dados.forEach( d => {
         ...
         this.arrHospitalizado.push ( { date, total: hospitalizedCurrently} );
         this.arrIntubado.push ( {date, total: inIcuCurrently} );
         this.arrMortes.push ( {date, total: death} );

         console.log(this.arrPositivo)
     });
 }
}
</script>
